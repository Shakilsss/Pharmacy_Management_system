...
$sql="  SELECT customer_orders.*,  orders.customer_id,orders.medicine_name,SUM(orders.total) as total  
        FROM customer_orders INNER JOIN orders ON customer_orders.id= orders.customer_id  
        WHERE  customer_orders.date 
