            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a style="text-decoration: none"class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-pills"></i><span class="hide-menu">Medicine</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a style="text-decoration: none"href="medicine_add.php" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Add Medicine</span></a></li>
                                <li class="sidebar-item"><a style="text-decoration: none"href="medicine_manage.php" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Manage Medicine</span></a></li>
                            </ul>
                        </li>  

                        <li class="sidebar-item"> <a style="text-decoration: none"class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fab fa-linode"></i><span class="hide-menu">Stock</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a style="text-decoration: none"href="instock.php" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> In Stock</span></a></li>
